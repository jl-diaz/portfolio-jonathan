    ...
    <section id="about" ref={sectionRef} className="py-24 px-6 md:px-20 max-w-7xl mx-auto">
      <div ref={contentRef} className="flex flex-col md:flex-row gap-16 items-center">
        ...
        <div className="md:w-1/2 grid grid-cols-1 sm:grid-cols-2 gap-6 w-full">
          <div className="bg-secondary/20 p-6 rounded-2xl border border-gray-800 hover:border-accent transition-colors duration-300">
          ...
          <div className="bg-secondary/20 p-6 rounded-2xl border border-gray-800 hover:border-accent transition-colors duration-300">
            ...
            <p className="text-gray-400 text-sm">Tesorero de la institución, aportando organización, liderazgo y trabajo en equipo.</p>
          </div>
        </div>
